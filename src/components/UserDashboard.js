...
const MainContent = () => {
  ...
  const togglePopup = async () => {
    try {
      ...
      const sampleDonors = [
        { name: '12/04/2025', bloodGroup: '1pm-2pm' }
  ...
  return (
    <div className="main-content">
      ...
      <div className="button-container">
        <ButtonBox buttonText="View Appointments" onClick={togglePopup} />
        <ButtonBox buttonText="Update Profile" onClick={() => fetchData('api_endpoint_2')} />
        <ButtonBox buttonText="Search for Donors" onClick={() => fetchData('api_endpoint_3')} />
